...
\label{sub:motivacao}
\lipsum[1]
% subsection motivacao (end)

\subsection{Contextualização/Enquadramento} % (fold)
\label{sub:contextualiza_o_enquadramento}
\lipsum[2]
% subsection contextualiza_o_enquadramento (end)

\subsection{Objectivos} % (fold)
